...
<Switch>
    <Route exact path='/login' render={()=> <Auth_Page authType="login" isAuthenticated={auth.isAuthenticated}  isAuthenticated_f={auth.isAuthenticated_f}  isAuthenticated_a={auth.isAuthenticated_a} /> }/>
    <Route exact path='/Register' render={()=> <Auth_Page_2 authType="register"  isAuthenticated={auth.isAuthenticated}/>}/>
